...
## All dictionaries are saved inside list
...
#remove the response code and the opening and closing brackets and then it will become the list with dictionaries as its items
