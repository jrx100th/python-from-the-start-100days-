...
def get_and_parse_data(inp_iata_code):
    ...
    # print("Data to go to :",inp_iata_code)
    # print("Departure date and time")
    # print(in_dates,"\n")
    # print("Arrival time and date")
    # print(out_dates,"\n")
...
def run_for_each():
    for key in our_req:
        ...
        if float(min(values[5])) < float(our_req[key][0]):
            ...
            # make a connection and send the email
            # informing the user for cheaper ticket option
...
# print(our_req[0]['PAR'][1])

# print(response)

# print(type(our_req[8]["DEL"][0]))